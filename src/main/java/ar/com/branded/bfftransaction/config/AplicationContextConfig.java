...
import ar.com.branded.bfftransaction.service.impl.GetPageableProductsService;
...
public class AplicationContextConfig {
    ...
    @Bean(name = "getPageableProducts")
    public GetPageableProducts getPageableProducts(){return new GetPageableProductsService();}
    @Bean(name = "retriverProducts")
    public RetriverProducts retriverProducts(JdbcTemplate jdbcTemplate){return new RetriverProductsSupabase(jdbcTemplate);}
